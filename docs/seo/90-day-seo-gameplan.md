...
## August 3 Report Baseline

Source: SE Ranking project report for July 28, 2026 through August 3, 2026.

- Keywords in SERPs: 50.
- Positions up: 16.
- Positions down: 15.
- Keywords in top 3: 13, up 1.
- Keywords in top 10: 24, up 2.
- Keywords in top 30: 41, down 1.
- Reported search visibility panel: 0%, with average position near 84.
- Largest reported drops: `website design pricing Kansas City`, `website design cost Kansas City`, `contractor website design kansas city`, `seo agency kansas city`, and `local business website design kansas city`.
- Strongest visible winners: `restaurant website design Kansas City`, `website designer Leawood`, `website design Leawood`, `home services website design Kansas City`, `contractor website design Kansas City`, `contractor seo Kansas City`, and `how much does a website cost in Kansas City`.
- AI metrics: 0% mention presence and 40% link presence for tracked prompts.

Treat the August 3 report as a recovery, consolidation, and proof-expansion signal. The next site pass should recover cost/pricing terms, strengthen broad Kansas City website-design relevance, push local-business website design toward top 10, and protect niche winners without creating thin suburb, Johnson County, or HVAC pages.
...
- Keep `/website-design-cost-kansas-city` as the target for `website design pricing Kansas City`, `website design cost Kansas City`, `web design cost Kansas City`, and `how much does a website cost in Kansas City`.
- Keep `/services/search-engine-optimization` as the target for `seo agency Kansas City`, SEO services, and local SEO support.
...
- Add contextual links to `/website-design-cost-kansas-city` where copy discusses website design cost, website design pricing, web design cost, $800 websites, or budget planning.
- Add contextual links to `/services/search-engine-optimization` where copy discusses local SEO, SEO agency support, Search Console review, or ongoing visibility.
...
## August Recovery Priorities

- Refresh `/services/website-design` around broad Kansas City website design, web design company, website designer, and website design agency intent while keeping one primary URL for the broad service.
- Refresh `/website-design-cost-kansas-city` with August 2026 pricing language, visible pricing guidance, and FAQs for cost/pricing variants.
- Refresh `/services/small-business-websites` for local business website design, affordable website design, and custom websites for small businesses.
- Refresh `/services/search-engine-optimization` for SEO agency Kansas City and local SEO support, with links to contractor and home-service proof.
- Keep restaurant, Leawood, contractor, and home-service pages stable with only proof and internal-link improvements because the August report shows those pages already have meaningful ranking traction.
