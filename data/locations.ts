...
export const locations: LocationItem[] = [
  ...
  },
  {
    ...
    localAngle:
      "Built for polished, competitive businesses that need to look credible fast and turn more local attention into real opportunities.",
    whyTitle: "Why Hometown works for Overland Park businesses",
    whyDescription:
    ...
    faqItems: [
      {
        question: "Can this help an Overland Park business stand out in a crowded market?",
        answer:
          "Yes. The work is designed to sharpen positioning, improve the first impression, and help the business look more credible when prospects compare options."
      },
      {
        question: "Are you a fit for smaller businesses in Overland Park too?",
        answer:
          "Yes. The focus is not company size. It is whether the business needs a more professional presence, better visibility, and clearer lead flow."
      },
      {
        question: "What usually matters most first: the website or traffic?",
        answer:
          "For most businesses, the website and messaging come first. Better traffic helps less if the site still looks weak or unclear once people land."
      }
    ],
  ...
  },
  {
    ...
    localAngle:
      "Built for service-driven businesses that want more calls, more quote requests, and less wasted marketing effort.",
    whyTitle: "Why this approach works in Olathe",
    whyDescription:
    ...
    faqItems: [
      {
        ...
        answer:
          "That is the point. The pages, structure, and messaging are built to reduce friction and make it easier for customers to reach out."
      },
      {
        question: "What should an Olathe business fix first if leads feel slow?",
        answer:
          "Usually the website and messaging. If the site does not look credible or make the next step obvious, more traffic will not solve the real problem."
      },
      {
        question: "Do I need ads, SEO, or just a better website?",
        answer:
          "It depends on where the business is now. The first step is figuring out what will move the business forward fastest instead of forcing a bigger package."
      }
    ],
    relatedProjectSlugs: ["wrapped-up-moving", "zj-carpentry-and-more", "lupi-docs"],
    ...
    faqItems: [
      {
        ...
        answer:
          "Yes. The goal is a more polished, business-specific presence, not a recycled template with nicer colors."
      },
      {
        question: "Is this only for businesses trying to save money?",
        answer:
          "No. It is for businesses that want serious quality and clarity without paying for inflated process and retainers they do not need."
      },
      {
        question: "Can you improve both the website and the visual presentation?",
        answer:
          "Yes. Website design, brand direction, and supporting creative can all be aligned so the business feels more cohesive online."
      },
      {
        question: "Can you help if I am looking for a website designer in Leawood?",
        answer:
          "Yes. Hometown builds custom websites for Leawood businesses that need stronger presentation, clearer service messaging, local proof, and a simple path to calls or quote requests."
      }
    ],
    relatedProjectSlugs: ["plate-kc", "lupi-docs", "voxwhite"],
  ...
  },
  {
    ...
    localAngle:
      "Built for businesses that need straightforward performance: better local search visibility, a clearer website, and a more direct path to contact.",
    whyTitle: "Why this works for Lenexa businesses",
    whyDescription:
      "The work stays practical and focused on what matters: looking professional, getting found, and making it easy for people to become leads.",
    trustHighlights: ["Clearer positioning", "SEO-first structure", "Direct lead flow", "Built for Lenexa visibility"],
    whyPoints: [
    ...
    faqItems: [
      {
        question: "Can this help a Lenexa business rank better locally?",
        answer:
          "Yes. Better local visibility usually starts with stronger site structure, clearer service messaging, and pages that make more sense for search and for people."
      },
      {
        question: "What if the website already exists but just feels weak?",
        answer:
          "That is a common fit. Many businesses do not need to start from zero; they need a better version of what they already have."
      },
      {
        question: "What kinds of businesses is this best for in Lenexa?",
        answer:
  ...
  },
  {
    ...
    localAngle:
      "Built for owner-led businesses that want honest support, stronger trust online, and marketing that feels practical instead of inflated.",
    whyTitle: "Why Shawnee businesses choose Hometown",
    whyDescription:
    ...
    faqItems: [
      {
        ...
        answer:
          "No. It is for businesses that want practical, effective work without paying for unnecessary layers of agency process."
      },
      {
        question: "What kind of Shawnee businesses is this for?",
        answer:
          "It is a strong fit for service businesses and owner-led local companies that want a more credible online presence and a clearer path to leads."
      },
      {
        question: "What usually matters most first?",
        answer:
          "For most businesses, the website and messaging matter first. Once the core presence is stronger, SEO, social, and other support work better too."
      }
    ],
    relatedProjectSlugs: ["wrapped-up-moving", "zj-carpentry-and-more", "lupi-docs"],
