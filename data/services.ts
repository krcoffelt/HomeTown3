...
export const services: ServiceItem[] = [
  ...
  },
  {
    ...
    detailSections: [
      ...
      {
        eyebrow: "Website Path",
        title: "Choose the path that matches where the business is now.",
        body:
          "A starter website, redesign, and growth website solve different problems. The goal is to match the scope to the stage of the business instead of selling more website than the owner needs.",
        items: ["Starter website for a credible first presence", "Redesign for outdated or confusing sites", "Growth website for more services, locations, SEO, and lead paths", "Local business website design Kansas City structure"]
      },
      {
        eyebrow: "Keyword Fit",
  ...
  },
  {
    ...
    seoDescription:
      "Social media management for small businesses that need consistent, on-brand content and a stronger online presence.",
    features: [
  ...
  },
  {
    ...
    seoDescription:
      "Graphic design support for businesses that need polished visuals across web, social, print, and promotional campaigns.",
    features: [
  ...
  },
  {
    ...
    seoDescription:
      "Analytics and tracking setup for small businesses that want better visibility into traffic, leads, and marketing performance.",
    features: [
  ...
  },
  {
    ...
    seoDescription:
      "Brand identity work for small businesses that need a stronger logo, clearer visual direction, and a more cohesive first impression.",
    features: [
