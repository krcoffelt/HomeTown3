...
export function PhoneIcon(props: IconProps) {
  return (
    <IconBase {...props}>
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.86 19.86 0 0 1 3.08 5.18 2 2 0 0 1 5.06 3h3a2 2 0 0 1 2 1.72l.35 2.45a2 2 0 0 1-.57 1.7l-1.3 1.3a16 16 0 0 0 5.16 5.16l1.3-1.3a2 2 0 0 1 1.7-.57l2.45.35A2 2 0 0 1 22 16.92Z" />
    </IconBase>
  );
}
