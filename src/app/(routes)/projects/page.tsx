      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex items-center justify-center gap-4 mb-6">
              <span className="text-2xl font-light text-gray-400">(2016-25©)</span>
            </div>
          ...
          {/* Filter Controls - Matching original Fabrica site */}
          <div className="mb-12">
          ...
          {/* Projects Grid - Matching original Fabrica site */}
